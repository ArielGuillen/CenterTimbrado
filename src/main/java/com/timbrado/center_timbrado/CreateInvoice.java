...
public class CreateInvoice{
	...
	public static void main( String [] args ) throws IOException, FacturamaException, Exception {
	    ...
	    cfdi.setNameId( Facturama.facturama.Catalogs().NameIds().get(1).getValue());
	    cfdi.setCfdiType( CfdiType.Ingreso.getValue() );
	    cfdi.setNameId( Facturama.facturama.Catalogs().NameIds().get(1).getValue());
	    cfdi.setExpeditionPlace("78216");
	    cfdi.setPaymentForm( Facturama.facturama.Catalogs().PaymentForms().get(3).getValue());
	    ...
	    com.Facturama.sdk_java.Models.Response.Cfdi cfdiCreated = Facturama.facturama.Cfdis().Create(cfdi);
	}
